...
from sqlalchemy import Column, Integer, String, TIMESTAMP, DateTime, create_engine, func
from sqlalchemy.dialects.mysql import BIGINT
from sqlalchemy.orm import relationship
from sqlalchemy.schema import ForeignKey
from datetime import datetime
from iggyref import settings
from iggytools.util import getPStr

engine = create_engine('mysql://iggyref:%s@db-internal:3306/%s' % (getPStr(), settings.DB_NAME), echo=True)
