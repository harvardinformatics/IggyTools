...
tasks += [ dict(taskName = 'unzip',             inFiles = 'SNPFILE',                     outFiles = 'UNZIPPEDSNPFILE'),
           dict(taskName = 'unzip-untar-merge', inFiles = 'chromFa.tar.gz',              outFiles = ['chromFa', 'chromFa.fa']),
           dict(taskName = 'txt2gtf',           inFiles = ['refGene.txt', 'chromFa.fa'], outFiles = 'refGene.gtf'),
